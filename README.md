...
To execute one of the scripts with a single command, select one of the following commands based on your setup preference and whether you want the panel at the top or the bottom of the screen, and run it in your terminal.
